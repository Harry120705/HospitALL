<template>
  ...
  >
    <form @submit.prevent="submit" class="modal-form">
      ...
      <div class="form-row">
        <label class="form-label" for="setor-nome-edit">Nome do Setor *</label>
        <input
          id="setor-nome-edit"
          v-model="form.nome"
          type="text"
      ...
      <div class="form-row">
        <label class="form-label" for="setor-desc-edit">Descrição *</label>
        <input
          id="setor-desc-edit"
      ...
      <div class="form-grid-2">
        <div class="form-row">
          <label class="form-label" for="setor-capacidade-edit">Capacidade (leitos) *</label>
          <input
            id="setor-capacidade-edit"
        ...
        <div class="form-row">
          <label class="form-label" for="setor-icone-edit">Ícone</label>
          <select id="setor-icone-edit" v-model="form.icone" class="form-input">
...
import { LayoutGrid, AlertCircle, Save, Loader2 } from 'lucide-vue-next';
...
watch(() => props.modelValue, (v) => {
  ...
  if (v) {
    ...
    form.value = {
      ...
      capacidade_maxima: props.initialData?.capacidade_maxima || 1,
      icone: props.initialData?.icone || 'bed-double',
    };
  }
});
...
async function submit() {
  ...
  errorMsg.value = '';
  try {
    const editado = await hospitalStore.editarSetor(props.initialData._id, form.value);
    toastStore.success('Área atualizada com sucesso!');
